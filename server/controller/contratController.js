...
const createContrat = async (req, res) => {
  try {
    ...
    sendSuccessResponse(res, 201, 'Contrats créer avec succès', result);
  } catch (error) {
...
const updateContrat = async (req, res) => {
  try {
    ...
    sendSuccessResponse(res, 200, 'Contrats mis à jour avec succès', result);
  } catch (error) {
    return res.status(500).json({ error: error.message });
  }
};
const deleteContrat = async (req, res) => {
  try {
    ...
    sendSuccessResponse(res, 200, 'Contrats supprimé avec succès', result);
  } catch (error) {
    return res.status(500).json({ error: error.message });
  }
};
